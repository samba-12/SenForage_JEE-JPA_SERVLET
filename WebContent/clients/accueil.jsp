  ...
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <div class="top-menu">
        <ul class="nav pull-right top-menu">
          <li><a class="logout" href="http://localhost:8080/SEN_FORAGE/index.jsp">Deconnexion</a></li>
        </ul>
      </div>
    </header>
    <!--header end-->
    ...
    <!--main content start-->
      ...
      <section class="wrapper">
        	<div class="senlogo">
             <img  src="http://localhost:8080/SEN_FORAGE/public/img/senforage.png">  
              <a class="titre"> <h2>Bienvenu dans <b>SEN <span>FORAGE</span></b></a></h2>
             <h3>Application de Gestion de la distribution d'eau dans les zones rurales</h3>
            </div>
             </div> 
   			 <div>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
    	var unique_id = $.gritter.add({
            ...
            title: 'Bienvenue dans Sen Forage!',
            // (string | mandatory) the text inside the notification
            text: 'ATTENTION!!! Ne communiquez pas votre login et mot de passe a des personnes tierces',
            // (string | optional) the image to display on the left
            image: 'http://localhost:8080/SEN_FORAGE/public/img/bathie.png',
